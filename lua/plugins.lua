...
function M.setup()
  ...
  local function plugins(use)
    ...
    -- Better surround
    use { "tpope/vim-surround", event = "BufReadPre" } -- 사용법 숙지가 필요함.
    use {
    ...
    -- Motions
    use {
      "andymass/vim-matchup", -- 사용법 숙지가 필요함.
      event = "CursorMoved",
      setup = function()
    ...
    -- }
    use {
      "chentoast/marks.nvim", -- 사용법 숙지가 필요함.
      event = "BufReadPre",
      config = function()
        require("marks").setup {}
      end,
    ...
    use {
      ...
      requires = {
        ...
        { "wifndwp/nvim-ts-autotag", event = "InsertEnter" },
    ...
    use { "mg979/vim-visual-multi", event = "BufReadPre", disable = false } -- 사용법을 익혀봐야할듯
    -- use {
